...
public final class NBTBaseReflection {
	...
	public static final byte TagEndId = 0, TagByteId = 1, TagShortId = 2, TagIntId = 3, TagLongId = 4, TagFloatId = 5,
			TagDoubleId = 6, TagByteArrayId = 7, TagStringId = 8, TagListId = 9, TagCompoundId = 10, TagIntArrayId = 11,
			TagLongArray = 12, TagNumber = 99;
	...
	/**
	 * <p>
	 * Checks whenever the given object is an instance of NMS {@code NBTBase}
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Make a call to {@code NBTBase::clone}
	 * </p>
	 * 
	 * @param obj The tag to clone (any subclasses of NMS {@code NBTBase}).
	 * @return Returns a clone of the tag (created by calling
	 *         {@code NBTBase::clone}).
	 */
	...
	/**
	 * <p>
	 * Make a call to {@code NBTBase::isEmpty}
	 * </p>
	 * <p>
	 * Implementation notice: This method does not exist any more in NBTBase since
	 * MC 1.13
	 * </p>
	 * 
	 * @param obj The tag to clone (any subclasses of NMS {@code NBTBase}).
	...
	/**
	 * <p>
	 * Gets the string representation of the tag value.
	 * </p>
	 * <p>
	 * Implementation changes: method renamed from '{@code c_()}' to
	 * '{@code asString()}' in MC 1.13
	 * </p>
	 * 
	 * @param obj The tag to get the string from (any subclasses of NMS
	 *                {@code NBTBase}).
	 * @return Returns the string representation of the tag (see {@code NBTBase::c_}
	 *         or {@code NBTBase::asString}).
	 */
	...
	/**
	 * <p>
	 * Create a new (empty) tag, as implemented in {@code NBTBase::createTag}
	 * </p>
	 * <p>
	 * Implementation changes: {@code protected} access modified has been removed in
	 * MC 1.13
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Gets a tag type string representation (differs from tag type names as in
	 * {@link #getTypeList()}).
	 * </p>
	 * <p>
	 * Implementation changes: THis method has changed a lot, it may exists or not
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Gets the type of the given tag.
	 * </p>
	 * 
	 * @param obj The tag to get the type from (any subclasses of NMS
	 *                {@code NBTBase}).
	...
	/**
	 * <p>
	 * Gets the list of tag type names.
	 * </p>
	 * <p>
