...
public final class NMSReflection {
	...
	static {
		...
		if (NMSReflection.canUseNMS()) {
			String[] array = org.bukkit.Bukkit.getServer().getClass().getPackage().getName().replace(".", ",")
					.split(",");
	...
	public static Method getPossibleMethods(Class<?> source, String names[], Class<?>... argsType)
	...
	public static Object getMethodOrField(Class<?> src, String methodName, String fieldName)
