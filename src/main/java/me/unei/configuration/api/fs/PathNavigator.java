...
public final class PathNavigator<T extends NavigableFile> implements IPathNavigator<T> {
	 ...
	 * @deprecated The {@linkplain PathSymbolsType type of the symbols} are given as
	 *             parameter every times.
	 */
	@Deprecated
	 ...
	 * <p>
	 * Removes the 'parent' and 'child' components where unneeded.
	 * </p>
	 * 
	 ...
	 * @param type  The types of the symbols used in the path.
	 * @return Returns `true` if the next(s) character(s) is/are the 'parent'
	 *         one(s).
	 */
	 ...
	 * @param index The index in the path string where the check should occur.
	 * @param type  The types of the symbols used in the path.
	 * @return Returns `true` if the next(s) character(s) is/are the elements
	 *         separator(s) one(s).
	 */
	 ...
	 * @param index The index in the path string where the check should occur.
	 * @param type  The types of the symbols used in the path.
	 * @return Returns `true` if the next(s) character(s) is/are the elements' index
	 *         prefix one(s).
	 */
