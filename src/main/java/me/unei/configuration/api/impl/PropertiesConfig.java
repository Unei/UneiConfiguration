...
public class PropertiesConfig extends UntypedFlatStorage<PropertiesConfig> implements IFlatPropertiesConfiguration {
	...
	public void save() {
		...
		try {
			...
			UneiConfiguration.getInstance().getLogger()
					.warning("An error occured while saving Properties file " + getFileName() + ":");
			e.printStackTrace();
		}
	}
	...
	public void reload() throws FileFormatException {
		...
		try {
			...
			UneiConfiguration.getInstance().getLogger()
					.warning("An error occured while loading Properties file " + getFileName() + ":");
			e.printStackTrace();
	...
	public String tryGetString(String key) throws NoFieldException {
		...
		String res = data.getProperty(key);
